							...
							<tbody>
								...
								>
									<td v-if="activeColumns.index">
										<RouterLink :to="taskDetailRoutes[t.id ?? 0]">
											{{ getTaskIdentifier(t) }}
										</RouterLink>
									</td>
									...
									<td v-if="activeColumns.project">
										<RouterLink
											v-if="projectList.projects[t.project_id ?? 0]"
											:to="{ name: 'project.index', params: { projectId: t.project_id } }"
										>
											{{ projectList.projects[t.project_id ?? 0].title }}
										</RouterLink>
									</td>
