			...
			<ul class="p-2 tasks">
				...
				>
					<SingleTaskInProject
						:show-project="true"
						:the-task="task"
						:can-mark-as-done="(projectList.projects[task.project_id ?? 0]?.max_permission ?? 0) > PERMISSIONS.READ"
...
const taskQuery = useTasks(() => taskScope.value ?? {}, () => authStore.authenticated && taskScope.value !== null)
...
watch(
	[() => props.dateFrom, () => props.dateTo, filterIdUsedOnOverview, () => props.showOverdue, () => props.showNulls, () => props.labelIds],
